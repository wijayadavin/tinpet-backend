...
// mengirim request match berdasarkan id pet penerima request (petId):
router.post('/pet/match', // --> menghasilkan req.body
    ...
    async (req, res, next) => {
        try {
            ...
            // result1 = post data dari body ke table 'pet_matches'
